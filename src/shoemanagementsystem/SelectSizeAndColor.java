 ...
 * @author mnawa
 */
public class SelectSizeAndColor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Select Color and Size");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectSizeAndColor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelectSizeAndColor().setVisible(true);
            }
        });
    }
